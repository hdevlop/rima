...
import { PhoneInputProps } from '@/components/types';
   ...
   return (
      <BaseInput variant={variant} status={status} className={cn('h-9 gap-2',className)}>
         ...
         <Input
            ...
            className='border-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0 px-0'
            ref={inputRef}
            {...restProps}
         />
